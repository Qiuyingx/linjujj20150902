...
/** 
 * @ClassName: ContentEntityReplyDto 
 * @Description: TODO
 * @author qiuyingxiang
 * @date 2015年7月15日 上午11:49:56 
 *  
 */

public class ContentEntityReplyDto {
    /**
	 * 回复的数据库ID
	 */
	...
	public ContentEntityReplyDto (){
		
	}
	
	public ContentEntityReplyDto(ContentEntityReply reply ){
